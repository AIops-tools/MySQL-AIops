# Release notes — mysql-aiops 0.2.0
...
client lists **26 tools instead of 35**. The writes are not hidden
...
- **`skills/mysql-aiops/references/agent-guardrails.md`** — for driving this tool with a
