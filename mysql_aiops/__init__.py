"""mysql-aiops — governed MySQL / MariaDB DBA operations for AI agents.
...
``mysql_aiops.governance`` — this package has no external skill-family
...
try:
    __version__ = version("mysql-aiops")
